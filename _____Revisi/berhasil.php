...
<table width="470" border="0" align="center">
              <tr>
                ...
                <td height="20" align="left" valign="middle"><?php echo $row_sql['tgl_order']; ?></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td height="20" align="left" valign="middle">:</td>
                <td height="20" align="left" valign="middle"><?php echo $tujuan; ?></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td height="20" align="left" valign="middle">:</td>
                <td height="20" align="left" valign="middle"><?php echo $row_sql['tgl_berangkat']; ?></td>
              </tr>
              <tr>
		...
		<div style="text-align:center; font-size: 18px; font-weight: bold; margin-top: 40px;">
            Silahkan lakukan konfirmasi pembayaran dalam 24 jam<br />
            Mohon simpan Kode Order anda<br />
            Kode Order Anda : 
        </div>
        <div style="text-align:center; font-size: 36px; font-weight: bold; color: #1d9d74; margin-top: 10px;">
            <?php echo $kode ?>
        </div>
        <div style="text-align:center; margin-top: 10px;">
        <a href="cetak.php?kode_order=<?php echo $kode; ?>&&tujuan=<?php echo $colname_sql2; ?>&&jml_bus_a=<?php echo $jml_a; ?>&&jml_bus_b=<?php echo $jml_b; ?>
        &&lama_pjln=<?php echo $lama; ?>" target="_blank">Cetak</a></div>
    </div>
</div>
</body>
</html>
