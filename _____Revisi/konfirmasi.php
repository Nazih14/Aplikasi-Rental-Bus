...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $jtransfer = $_POST['jml_transfer'];
	if ((!$cek_kode == $_POST['kode_order']) or ($jtransfer > $tot) or ($jtransfer < $tot) ){
	  ...
	  $insertGoTo = "berhasil2.php?kode_order=$kode";
	  if (isset($_SERVER['QUERY_STRING'])) {
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
  <table width="634" align="left">
    <tr valign="baseline">
      ...
      <td width="477">
      <div class="form-item">
      <input type="text" name="kode_order" value="" size="32" required />
      </div></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td>
      <div class="form-item">
      <input type="text" name="no_rek" value="" size="32" required />
      </div></td>
    </tr>
    <tr valign="baseline">
      ...
      <td>
        <div class="form-item">
          <input type="text" name="jml_transfer" value="" size="32" required />
        </div></td>
    </tr>
    <tr valign="baseline">
