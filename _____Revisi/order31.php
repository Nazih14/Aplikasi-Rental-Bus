...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertGoTo = "berhasil.php?kode_order=$kode&&tujuan=$colname_sql2&&jml_bus_a=$jml_a&&jml_bus_b=$jml_b&&lama_pjln=$lama&&kota=";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table width="634" align="left">
    ...
    <tr valign="baseline">
      ...
      <td>
      <div class="form-item">
      <input type="text" name="tlp" value="" maxlength="12" require id="tlp" />
      </div></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td>
      <div class="form-item">
      <input id="angka"  name="jml_bus_b" value="0" size="32" required />
      </div></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" id="angka" name="jml_bus_a" value="0" size="32" required />
