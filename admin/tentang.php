...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE profil_po SET judul=%s, isi=%s WHERE id=%s",
...
mysql_select_db($database_database, $database);
$query_tentang = "SELECT * FROM profil_po WHERE id = 1";
$tentang = mysql_query($query_tentang, $database) or die(mysql_error());
$row_tentang = mysql_fetch_assoc($tentang);
$totalRows_tentang = mysql_num_rows($tentang);
?>
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table width="100%" align="center">
          <tr valign="baseline">
            ...
            <td width="1187">
            <div class="form-item">
            <input type="text" name="judul" value="<?php echo htmlentities($row_tentang['judul'], ENT_COMPAT, 'utf-8'); ?>" size="32" />
            </div></td>
          </tr>
          <tr valign="baseline">
            ...
            <textarea class="ckeditor" id="editor1" name="isi" style="height:500px; margin-bottom: 10px;" ><?php echo htmlentities($row_tentang['isi'], ENT_COMPAT, 'utf-8'); ?></textarea>
        ...
        <input type="hidden" name="id" value="<?php echo $row_tentang['id']; ?>" />
      </form>
      <p>&nbsp;</p>
    </div>
