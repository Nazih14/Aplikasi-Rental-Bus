...
<table width="470" border="0" align="center">
              ...
              <tr>
                ...
                <td height="20" align="left" valign="middle">:</td>
                <td height="20" align="left" valign="middle"><?php $tampil2=number_format($jml_transfer,0,",",".");  echo 'Rp '. $tampil2 ?></td>
              </tr>
              <tr>
        ...
        <a href="cetak_nota2.php?kode_order=<?php echo $kode; ?>&&jml_transfer=<?php echo $jml_transfer; ?>" target="_blank">Cetak</a></div>
    	</div>
