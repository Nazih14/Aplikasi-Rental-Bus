...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table width="634" align="left">
    ...
    <tr valign="baseline">
      ...
      <td>
      <div class="form-item">
      <input type="text" name="tlp" value="" maxlength="12" id="tlp" onKeyPress="return goodchars(event,'0123456789',this)"/>
      </div></td>
    </tr>
    <tr valign="baseline">
...
?>
    ...
    <tr valign="baseline">
      ...
      <td>
      <div class="form-item">
      <input name="jml_bus_b" value="0" size="32" required onKeyPress="return goodchars(event,'0123456789',this)"/>
      </div></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td>
      <div class="form-item">
      <input id="angka" name="lama_pjln" value="0" size="20" required onKeyPress="return goodchars(event,'0123456789',this)"/> Hari
      </div></td>
    </tr>
    <tr valign="baseline">
